...
class Attack:
    def __init__(self, input_file, output_file):
        ...
        self.model2 = YOLO(r'yolov5lu.pt')  # load a pretrained YOLOv8n model
    ...
    def run(self):
        ...
        results = self.model2.predict(source=noise_img)
        detections = plot_bboxes(image=noise_img, boxes=results[0].boxes.boxes, write_loc=self.output_file, score=True)
